    ...
    <div style={{ minHeight: "100vh", background: "#fff", color: "#111", fontFamily: "'Helvetica Neue', Helvetica, Arial, sans-serif" }}>
      ...
      <div style={{ padding: "8px 56px 56px" }}>
        {sorted.length === 0 ? (
          ...
          <>
            <div style={{ display: "grid", gridTemplateColumns: "32px 48px 1fr 160px 100px 110px 56px", gap: "0 16px", padding: "16px 8px 8px", borderBottom: "1px solid #efefef", fontSize: "10px", letterSpacing: "0.14em", color: "#bbb", textTransform: "uppercase" }}>
              <div>#</div><div>Cover</div><div>Title</div><div>Writer</div><div>Rating</div><div>Date Read</div><div></div>
            </div>
            {sorted.map((novel, i) => (
              <div key={novel.id}
                style={{ display: "grid", gridTemplateColumns: "32px 48px 1fr 160px 100px 110px 56px", gap: "0 16px", padding: "10px 8px", borderBottom: "1px solid #f5f5f5", alignItems: "center", transition: "background 0.1s", borderRadius: "4px", margin: "0 -8px" }}
              ...
              >
                ...
                <div style={{ display: "flex", gap: "4px", alignItems: "center" }}>
                  <button onClick={() => openEdit(novel)}
                    style={{ background: "transparent", border: "none", color: "#ccc", cursor: "pointer", padding: "4px", lineHeight: 1, transition: "color 0.15s", display: "flex", alignItems: "center" }}
                  ...
                  <button onClick={() => handleDelete(novel.id)}
                    style={{ background: "transparent", border: "none", color: "#ddd", cursor: "pointer", fontSize: "18px", padding: "0 2px", lineHeight: 1, transition: "color 0.15s" }}
              ...
              <>
                ...
                <div style={{ marginBottom: "20px" }}>
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: "14px" }}>
                    ...
                    <div style={{ flex: 1 }}>
                      <input ref={fileInputRef} type="file" accept="image/*" onChange={handleCoverChange} style={{ display: "none" }} id="cover-upload" />
                      ...
                      >{coverPreview ? "Change image" : "Choose image"}</label>
                      {coverPreview && (
                ...
                <div style={{ display: "flex", gap: "10px" }}>
                  ...
                  <button onClick={() => { setShowForm(false); setError(""); resetForm(); }} style={{ background: "#fff", color: "#999", border: "1px solid #e5e5e5", padding: "11px 18px", fontSize: "13px", fontFamily: "inherit", cursor: "pointer", borderRadius: "4px" }} onMouseEnter={e => e.target.style.borderColor = "#ccc"} onMouseLeave={e => e.target.style.borderColor = "#e5e5e5"}>Cancel</button>
                </div>
              </>
            )}
          </div>
      ...
      {editingId && (
        <div onClick={(e) => { if (e.target === e.currentTarget) setEditingId(null); }}
          style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.18)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 100, padding: "20px" }}
        >
          <div style={{ background: "#fff", border: "1px solid #e5e5e5", borderRadius: "8px", padding: "36px", width: "100%", maxWidth: "400px", boxShadow: "0 4px 32px rgba(0,0,0,0.08)" }}>
            ...
            <div style={{ display: "flex", gap: "10px" }}>
              ...
              <button onClick={() => setEditingId(null)} style={{ background: "#fff", color: "#999", border: "1px solid #e5e5e5", padding: "11px 18px", fontSize: "13px", fontFamily: "inherit", cursor: "pointer", borderRadius: "4px" }} onMouseEnter={e => e.target.style.borderColor = "#ccc"} onMouseLeave={e => e.target.style.borderColor = "#e5e5e5"}>Cancel</button>
            </div>
          </div>
        </div>
      )}
