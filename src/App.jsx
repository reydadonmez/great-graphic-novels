...
const EMPTY_FORM = { title: "", writer: "", rating: 0, dateRead: "" };
    ...
    <div style={{ minHeight: "100vh", background: "#fff", color: "#111", fontFamily: "'Helvetica Neue', Helvetica, Arial, sans-serif" }}>
      ...
      <div style={{ padding: "8px 56px 56px" }}>
        {sorted.length === 0 ? (
          ...
          <>
            <div style={{ display: "grid", gridTemplateColumns: "32px 1fr 160px 100px 110px 56px", gap: "0 16px", padding: "16px 8px 8px", borderBottom: "1px solid #efefef", fontSize: "10px", letterSpacing: "0.14em", color: "#bbb", textTransform: "uppercase" }}>
              <div>#</div><div>Title</div><div>Writer</div><div>Rating</div><div>Date Read</div><div></div>
            </div>
            {sorted.map((novel, i) => (
              <div key={novel.id}
                style={{ display: "grid", gridTemplateColumns: "32px 1fr 160px 100px 110px 56px", gap: "0 16px", padding: "14px 8px", borderBottom: "1px solid #f5f5f5", alignItems: "center", transition: "background 0.1s", borderRadius: "4px", margin: "0 -8px" }}
